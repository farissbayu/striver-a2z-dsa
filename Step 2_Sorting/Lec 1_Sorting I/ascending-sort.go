...
/*
find the index, swap with current outer loop position
*/
...
/*
swap 2 element if the position false
inner loop smaller time by time
*/
...
func main() {
	fmt.Println("- Ascending | Sorting Part 1 -")
